...
public class Player_CS_EF : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (device.PrimaryInputDevice.GetButton(VRButton.Trigger) && rightCanFire && canBothFire)
            {
            ...
            if (device.SecondaryInputDevice.GetButton(VRButton.Trigger) && leftCanFire && canBothFire)
            {
                // Checks if the basic cannon is unlocked
                if (LevelManager_CS_EF.instance.basicCannon == true)
                {
    ...
    IEnumerator FireRightProjectile()
    {
        ...
        AudioSource.PlayClipAtPoint(basicCannonSFX, rightCannon.transform.position, volumeLevel);
    ...
    IEnumerator FireLeftProjectile()
    {
        ...
        // Plays an audio sound of the cannon
        AudioSource.PlayClipAtPoint(basicCannonSFX, leftCannon.transform.position, volumeLevel);
